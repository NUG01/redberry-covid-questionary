    ...
    <Form @submit="onSubmit" class="flex flex-col w-[100%] mt-[4.2rem]">
     ...
     <div class="flex flex-col gap-[8px]">
      ...
      <div class="flex flex-col gap-[1.1rem]">
        <radio-input type="radio" value="once_a_week" rules="required" id="meet2" name="non_formal_meetings" label="კვირაში ერთხელ"/>
        <radio-input type="radio" value="once_two_week" rules="required" id="meet3" name="non_formal_meetings" label="ორ კვირაში ერთხელ"/>
        <radio-input type="radio" value="once_a_month" rules="required" id="meet4" name="non_formal_meetings" label="თვეში ერთხელ"/>
      ...
      <div class="flex flex-col gap-[1.1rem]">
         <radio-input type="radio" value="0" rules="required" id="day" name="number_of_days_from_office" label="0"/>
         <radio-input type="radio" value="1" rules="required" id="day1" name="number_of_days_from_office" label="1"/>
         <radio-input type="radio" value="2" rules="required" id="day2" name="number_of_days_from_office" label="2"/>
         <radio-input type="radio" value="3" rules="required" id="day3" name="number_of_days_from_office" label="3"/>
         <radio-input type="radio" value="4" rules="required" id="day4" name="number_of_days_from_office" label="4"/>
         <radio-input type="radio" value="5" rules="required" id="day5" name="number_of_days_from_office" label="5"/>
...
export default {
  name:"AdvicesForm",
 components:{Form,Field,LeftArrow, AdviceText, RadioInput,ErrorMessage},
  setup(){
